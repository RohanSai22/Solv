    ...
    >
      <div className="w-full max-w-4xl text-center mx-auto">
          <div className="mx-auto bg-accent/10 p-4 rounded-full w-fit mb-4">
            <Icons.logo className="h-16 w-16 text-accent" />
          </div>
          <h1 className="font-headline text-4xl md:text-5xl font-bold tracking-tighter text-accent">Welcome to Solv</h1>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 text-left">
            {features.map((feature) => (
              <Card 
                key={feature.view} 
                className="hover:border-accent/80 hover:shadow-lg hover:shadow-accent/20 transition-all cursor-pointer transform hover:-translate-y-1"
