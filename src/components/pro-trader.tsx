...
export function ProTrader({ className }: { className?: string }) {
  ...
  return (
    <motion.div
      ...
      className={className}
    >
      <Card className="flex flex-col w-full max-w-md border-2 border-amber-400 shadow-amber-400/20 shadow-lg">
        <CardHeader>
        ...
        <CardFooter>
          <Button className="w-full bg-amber-400 hover:bg-amber-500 text-black" disabled={isActionDisabled}>
